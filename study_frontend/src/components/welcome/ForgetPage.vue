<script setup>
import {ChatLineRound, Lock, Message} from "@element-plus/icons-vue";
...
<template>
  <div>
    ...
    <Transition name="el-zoom-in-center" mode="out-in" >
      <div style="text-align: center; margin:20vh 20px; height: 90%" v-if="active === 0">
        ...
        <div style="margin-top: 50px;">
          <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef" >
            <el-form-item prop="password">
              <el-input v-model="form.password" type="password" placeholder="输入新密码" maxlength="20">
                <template #prefix>
            ...
            <el-form-item prop="password_repeat">
              <el-input v-model="form.password_repeat" type="password" placeholder="重复输入新密码" maxlength="20">
                <template #prefix>
                  <el-icon><Lock /></el-icon>
                </template>
              </el-input>
